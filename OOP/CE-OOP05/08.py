...
class myStat:
    ...
    def myMean(self):
        self.Mean = self.mySum/len(self.myData); print("Summation = ", self.mySum)
    def myMaximum(self):
        self.myMax = max(self.myData); print("Maximum = ", self.myMax)
    def myMinimum(self):
        self.myMin = min(self.myData); print("Minimum = ", self.myMin)
    def myVariance(self):
...
I_need_to_know.mySummation(); I_need_to_know.myMean()
